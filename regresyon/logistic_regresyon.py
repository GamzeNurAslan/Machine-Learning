...
print("\nLojistik Regresyon Modeli Test Verisi ile Tahmin Yapılıyor...")
...
print("\nKNN Modeli Test Verisi İle Tahmin Yapılıyor...")
...
#KNN'nin iyi sonuç vermesi için fazla verinin olması gerekiyor elimizde :)
