...
print("Karar Ağacının Doğruluğu:", accuracy_score(y_test,tree_pred))
...
plt.title("Iris Turlerinin Petal Uzunluğu ve Genişliği")
plt.legend()
plt.grid(True)
plt.show()
...
plt.title("Karar Ağaç - Confusion Matrix")
plt.show()
